...
class AHydrSpectatorPawn;
class UZoomCameraComponent;

UCLASS()
class APlayerController1 : public APlayerController
{
	GENERATED_UCLASS_BODY()

public:
	// Begin PlayerController1 interface
	/** fixed rotation */
...
protected:
	...
	// End PlayerController1 interface
...
private:
	...
	AHydrSpectatorPawn* GetHydrSpectatorPawn() const;

	/** Helper to return camera component via spectator pawn. */
	UZoomCameraComponent* GetCameraComponent() const;
};
