...
UHydrInput::UHydrInput(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
	, PrevTouchState(0)
{
}

void UHydrInput::UpdateDetection(float DeltaTime)
{
	UpdateGameKeys(DeltaTime);
	ProcessKeyStates(DeltaTime);
}

void UHydrInput::ProcessKeyStates(float DeltaTime)
{
...
void UHydrInput::UpdateGameKeys(float DeltaTime)
{
	APlayerController1* Controller = CastChecked<APlayerController1>(GetOuter());
...
void UHydrInput::DetectOnePointActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition, FVector2D& AnchorPosition, float& DownTime)
{
...
void UHydrInput::DetectTwoPointsActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition1, const FVector2D& CurrentPosition2)
{
...
FVector2D UHydrInput::GetTouchAnchor(int32 i) const
{
