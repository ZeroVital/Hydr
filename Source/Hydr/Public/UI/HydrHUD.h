...
#include "HydrHUD.generated.h"

UCLASS()
class AHydrHUD : public AHUD
{
...
public:
	...
	*/
	...
	TSharedPtr<class SHUDMenuWidget> GetHUDWidget() const;
...
protected:
	...
	*/
	...
	class APlayerController1* GetPlayerController() const;

	/** HUD menu widget */
	TSharedPtr<class SHUDMenuWidget> HUDMenuWidget;
